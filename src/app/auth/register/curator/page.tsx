...
import { signUpCurator } from '@/app/auth/actions'

export const metadata: Metadata = {
  title: 'Register Your Market — WEAREMAKERS.PT',
...
export default async function RegisterCuratorPage({
  searchParams,
}: {
    ...
    return (
      <main style={{ background: 'var(--INK)', minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        <div style={{ width: '100%', maxWidth: '480px', textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'var(--LOGO)', fontWeight: 900, fontSize: '28px', textTransform: 'uppercase', color: 'var(--P)', marginBottom: '12px' }}>APPLICATION RECEIVED</div>
          <div style={{ fontFamily: 'var(--MONO)', fontSize: '15px', color: 'rgba(240,236,224,.5)', lineHeight: 1.6, marginBottom: '24px' }}>
            Check your email to confirm your address. Our team will review your application and set up your market within 48 hours. We'll be in touch.
          </div>
    ...
    <main style={{ background: 'var(--INK)', minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: '480px' }}>
        ...
        <div style={{ marginBottom: '32px', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            ...
            <div style={{ ...T, fontSize: '9px', color: 'rgba(240,236,224,.3)', marginTop: '6px' }}>
              Free for curators · Setup in 10 minutes
            </div>
          </div>
          <Link href="/welcome/curator" style={{ ...T, fontSize: '9px', color: 'rgba(240,236,224,.25)', textDecoration: 'none', marginTop: '4px' }}>
            ← BACK
          </Link>
        </div>
        ...
        <div style={{ background: 'var(--P)', border: '3px solid var(--P)', boxShadow: '8px 8px 0 0 var(--RED)' }}>
          <div style={{ background: 'var(--INK)', padding: '10px 16px', borderBottom: '3px solid var(--RED)' }}>
            <div style={{ ...T, fontWeight: 700, color: 'var(--P)' }}>REGISTER YOUR MARKET</div>
          </div>

          <form action={signUpCurator} style={{ padding: '20px' }}>
            ...
            {/* Info callout */}
            <div style={{ marginBottom: '20px', padding: '14px', background: 'var(--P2)', borderLeft: '3px solid var(--INK)' }}>
              <div style={{ ...T, fontSize: '9px', color: 'rgba(24,22,20,.5)', lineHeight: 1.7 }}>
                After registration, the WAM team will set up your market location, dates and calendar. You'll receive an email within 48 hours.
              </div>
            </div>

            <div style={{ marginBottom: '16px' }}>
              <label style={{ ...T, fontSize: '10px', color: 'rgba(24,22,20,.5)', display: 'block', marginBottom: '6px' }}>YOUR NAME *</label>
              <input type="text" name="display_name" required placeholder="e.g. João Ferreira" style={inputStyle} />
            </div>

            <div style={{ marginBottom: '16px' }}>
              <label style={{ ...T, fontSize: '10px', color: 'rgba(24,22,20,.5)', display: 'block', marginBottom: '6px' }}>MARKET NAME *</label>
              <input type="text" name="market_name" required placeholder="e.g. Feira do Intendente" style={inputStyle} />
              <div style={{ ...T, fontSize: '9px', color: 'rgba(24,22,20,.3)', marginTop: '5px' }}>The name of the market you organise</div>
            </div>

            <div style={{ marginBottom: '16px' }}>
              <label style={{ ...T, fontSize: '10px', color: 'rgba(24,22,20,.5)', display: 'block', marginBottom: '6px' }}>INSTAGRAM HANDLE</label>
              <input type="text" name="instagram_handle" placeholder="@yourmarket" style={inputStyle} />
            </div>
